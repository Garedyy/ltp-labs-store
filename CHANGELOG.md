...
- Home: the "Browse the shop" link now sits between the intro text and the trending grid,
  aligned to the end of its row, instead of after the eight product cards, so the way to the full
  catalogue is visible without scrolling on desktop and on a 320 px phone; DOM order and visual
