...
- **Current branch**: `development`, ahead of `main` = `v1.0.0` (released 2026-09-11) by the
  ...
  skills and reviewer agents), the footer fix for #26 (`fix/26-footer-bottom-short-pages`) and
  the gallery cap for #27 (`fix/27-cap-gallery-image`).
...
| 2026-09-13 | Issue #27 (product gallery image far too large): the gallery `<figure>` becomes `mx-auto w-full max-w-[min(100%,max(20rem,60svh))]` so the square image is bounded by 60 % of the viewport height (20 rem floor) and centred in its column, thumbnails follow, `preload` / `fetchPriority` unchanged; `tests/e2e/product.spec.ts` measures the cap at 1280 x 800 and 820 x 1180 and the full width on a phone; `DESIGN_SYSTEM.md`, `PROJECT_PLAN.md` 3.8 and `CHANGELOG.md` updated. Fix on `fix/27-cap-gallery-image`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
