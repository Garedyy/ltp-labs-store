...
- **Current branch**: `development`, ahead of `main` = `v1.0.0` (released 2026-09-11) by the
  ...
  #23 (#18 cart focus / header count / `noJs`), the documentation sync #17 and the Claude Code
  tooling (`fix-issue`, `commit-push`, `pull-request`, `merge-pr`, `project-review` skills and
  reviewer agents).
