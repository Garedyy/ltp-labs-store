...
- **Current branch**: `development`, ahead of `main` = `v1.0.0` (released 2026-09-11) by the
  ...
  gallery cap for #27 (`fix/27-cap-gallery-image`, PR #33) and the sort on selection for #25
  (`fix/25-sort-on-selection`, D-11).
