...
| Buy now, with JS (303 to the cart, followed as a navigation; flash rendered as `CartNotice`)                                          | `document.title` (pathname change)                                    | `#main` (route default)                                                |
| Buy now, without JS (303 to the cart, flash)                                                                                          | `CartNotice` (`role="status"`)                                        | the notice (`autoFocus`)                                               |
