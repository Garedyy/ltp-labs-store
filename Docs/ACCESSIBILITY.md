...
| Buy now accepted (303 to the order confirmation, followed as a navigation with JS, a full load without)                               | `document.title` (pathname change) / the new document                 | `#main` (route default) / document start                               |
