export default {
  ...
  search: {
    ...
    resultsTitle_zero: "Search: “{{q}}” (no results)",
    resultsTitle_one: "Search: “{{q}}” ({{count}} result)",
    resultsTitle_many: "Search: “{{q}}” ({{count}} results)",
    resultsTitle_other: "Search: “{{q}}” ({{count}} results)",
